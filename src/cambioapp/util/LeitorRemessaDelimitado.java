...
public class LeitorRemessaDelimitado extends LeitorRemessa{
	private DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyyMMdd");;//formatação unica para ser usada posteriormente nas interações
	
	public List<Transacao> converter(String caminhoArquivo){
		System.out.println("IMPLEMENTAÇÃO DELIMITADA");
